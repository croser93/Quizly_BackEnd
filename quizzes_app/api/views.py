...
class QuizzesView(APIView):
    ...
    def create_Quiz(self, url, request, quiz_json):
        """
        Create a Quiz instance and its related questions.

        video_url = the submitted YouTube URL
        user = the authenticated user (request.user)
        title = quiz_json['title'], generated by Gemini
        description = quiz_json['description'], generated by Gemini
        """
    ...
    def create_Question(self, quiz, quiz_json):
        """
        Create one Question instance per entry in quiz_json['questions'].

        quiz = the parent Quiz instance
        question_title = element['question_title'], generated by Gemini
        question_options = element['question_options'], generated by Gemini
        answer = element['answer'], generated by Gemini
        """
